...
class SftpFactory implements StorageFactoryInterface
{
    ...
    public function createService(array $parameters): ?StorageInterface
    {
        ...
        return new SftpStorage($this->logger, $host, $path, $username, $publicKeyFile, $privateKeyFile, $config[self::STORAGE_CONFIG_READ_ONLY], $config[self::STORAGE_CONFIG_TO_SKIP], $passwordPhrase, $port);
    }
    ...
    /**
     * @param array<string, mixed> $parameters
     * @return array{type: string, host: null|string, path: string, username: string, public-key-file: string, public-key-file: string, private-key-file: string, password-phrase: null|string, port: int, read-only: bool, to-skip: bool}
     */
    private function resolveParameters(array $parameters): array
    {
        ...
        /** @var array{type: string, host: null|string, path: string, username: string, public-key-file: string, public-key-file: string, private-key-file: string, password-phrase: null|string, port: int, read-only: bool, to-skip: bool} $resolvedParameter */
